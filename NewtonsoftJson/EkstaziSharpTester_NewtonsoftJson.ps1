...
$solutionName="Newtonsoft.Json"
$solutionUnderTestPath="$checkoutDir\$solutionName"
$solutionUnderTestSolutionFilePath="Src\Newtonsoft.Json.Net40.sln"
$programModulesPath="Src\Newtonsoft.Json.Tests\bin\Debug\Net40\Newtonsoft.Json.dll"
$testModulesPath="Src\Newtonsoft.Json.Tests\bin\Debug\Net40\Newtonsoft.Json.Tests.dll"
